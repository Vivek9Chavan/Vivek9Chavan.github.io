...
I presented our recent and ongoing work across the ECCV workshops, involving egocentric vision, procedural understanding, robot learning, and long-horizon vision-language-action manipulation.
...
<div style="display: flex; align-items: flex-start; gap: 20px; margin-bottom: 1.5em;">
  ...
  <div style="flex: 0 0 38%;">
    <img src="/assets/IMG_5633.jpeg"
         ...
         style="width: 100%; height: 420px; object-fit: cover; object-position: center; border-radius: 6px;">
  </div>

  <div style="flex: 1; text-align: left; font-size: 0.94em; line-height: 1.45;">
    ...
    <p>
      ...
      <a href="https://arxiv.org/abs/2608.22617">arXiv:2608.22617</a> · CIRP Annals 2026 ·
      <a href="https://indego-assistant.github.io/">Project</a>
    </p>
  </div>
