...
<div style="display: flex; gap: 12px; justify-content: center; align-items: flex-start; margin-bottom: 0.5em;"> <!-- Landscape image (will be wider naturally) --> <img src="/assets/IMG_0064.jpeg" alt="Expo booth at NeurIPS 2025" style="height: 300px; width: auto; border-radius: 6px;"> <!-- Portrait image (will be narrower naturally) --> <img src="/assets/IMG_0090.jpeg" alt="Expo demonstration at NeurIPS 2025" style="height: 300px; width: auto; border-radius: 6px;"> </div> <p style="text-align: center; font-style: italic; margin-top: -0.2em;"> Scenes from this year’s NeurIPS Expo. </p>
...
<div style="display: flex; align-items: center; gap: 20px; margin-top: 1.5em; margin-bottom: 1.5em;">
  ...
  <div style="flex: 0 0 50%; text-align: left;">
    ...
    <p>
      Presenting my own work at NeurIPS this year was an incredibly rewarding experience.
      What stood out most was the opportunity to interact with researchers from a wide range of backgrounds—
      some deeply experienced, others early in their journey, but all united by curiosity and a drive to push
      the field forward. These conversations, whether at the poster, in hallways, or during informal breaks,
      were as valuable as the formal sessions themselves.  
    </p>

    <p>
      It was energizing to meet so many people who share similar interests yet bring diverse perspectives,
      expertise, and ideas. Moments like these are what make conferences meaningful—they remind us that
      progress in AI is built not only on papers and models, but also on community and collaboration.
    </p>
  </div>
