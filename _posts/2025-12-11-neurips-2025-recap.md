...
<div style="display: flex; align-items: flex-start; margin-bottom: 1.5em; gap: 20px;">
  ...
  <div style="flex: 1;">
    ...
    <p>Richard Sutton opened NeurIPS 2025 with a keynote that set both the intellectual tone and emotional atmosphere of the conference. The room was completely full—thousands of researchers gathered before 9 a.m.—a reminder of how deeply foundational ideas still resonate in a field now dominated by scale and engineering.</p>

    <p>Sutton used the keynote to return to first principles: the nature of prediction, the essence of reinforcement learning, and the long-term perspective required to build agents that continually learn from interaction. What stood out was not just the technical framing, but the clarity with which he articulated something many of us intuitively feel—that despite the rise of massive models and unprecedented compute, the core challenges of learning, generalization, and representation remain as central as ever.</p>
  </div>
