...
<div style="display: flex; align-items: flex-start; margin-bottom: 1.5em; gap: 20px;">
  ...
  <div style="flex: 0 0 30%;">
    <img src="/assets/IMG_0572.jpeg" alt="View of the Gaslamp Quarter from NeurIPS venue" style="width: 100%; border-radius: 6px;">
  </div>

  <!-- Image 2 (30%) -->
  <div style="flex: 0 0 30%;">
    <img src="/assets/IMG_0435.jpeg" alt="San Diego Bay and Coronado near NeurIPS venue" style="width: 100%; border-radius: 6px;">
  </div>

  <!-- Text block (~40%) -->
  <div style="flex: 1;">
    <p><strong>Scenes from around the NeurIPS 2025 venue.</strong></p>

    <p>
      The San Diego Convention Center offered two very different but equally memorable views. 
      On one side, the historic Gaslamp Quarter added warmth and energy to the conference evenings, 
      with many participants heading out for dinner or casual conversations after a long day of sessions. On the other side, the San Diego Bay and Coronado created a calm backdrop where researchers could be 
      seen taking strolls, chatting in small groups, or simply stepping outside to clear their minds 
      between talks. These quieter, more human moments balanced the intensity of the event and reminded 
      everyone that conferences are as much about connection as they are about research.
    </p>
  </div>
