...
A week at NeurIPS 2025 in San Diego offered an intense mix of ideas, conversations, and research across every corner of AI. With record-breaking attendance and more than 21,000 submissions, the conference highlighted the dominance of large language models, the push toward reasoning and world models, and growing interest in multimodality and embodied AI. Keynotes covered paths to superintelligence, societal impacts, and how to evaluate “alien” AI systems. Poster sessions, demos, workshops, and industry booths created a broad and engaging atmosphere. For me, the most valuable part of the week was connecting with researchers, discussing shared interests, and experiencing the community’s energy first-hand.
